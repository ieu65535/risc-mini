...
always_comb begin
    ...
    case (opcode)
        ...
        `TYPE_S: begin
            op2_sel = `OP2_IMS;
            case (funct3)
                `SB: begin inst_valid = 1'b1; mem_mask = 4'b0001; end
                `SH: begin inst_valid = 1'b1; mem_mask = 4'b0011; end
                `SW: begin inst_valid = 1'b1; mem_mask = 4'b1111; end
                default: begin end
            endcase
        end
        `JAL: begin
        ...
        `SYSTEM: begin
            if (funct3 == 3'b000) begin
                ...
                if (csr_addr_readable && (!csr_write_req || csr_addr_writable)) begin
                    inst_valid = 1'b1;
